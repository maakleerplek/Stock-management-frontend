...
export default function Extras({ onExtraCostChange }: ExtrasProps) {
    ...
    return (
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            {/* Lasertime Input */}
            <div className="space-y-1 border-2 border-brand-black p-3 bg-brand-beige">
                ...
                <div className="flex items-center gap-3">
                    <input
                        ...
                        min="0"
                        className="brutalist-input w-full font-mono bg-brand-beige h-9 px-3 border-2 border-brand-black focus:border-sky-500 focus:bg-sky-50/10 transition-all outline-none text-sm"
                        placeholder="0"
                    />

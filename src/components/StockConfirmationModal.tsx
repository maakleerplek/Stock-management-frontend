              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="flex items-center gap-3 text-sm font-bold text-brand-black/60">
                    <span className="bg-brand-beige-dark border border-brand-black/30 text-brand-black px-2 py-0.5">{adj.currentQty ?? '?'}</span>
                    <ArrowRight size={16} />
                    <span className="bg-brand-beige-dark border border-brand-black/30 text-brand-black px-2 py-0.5">
